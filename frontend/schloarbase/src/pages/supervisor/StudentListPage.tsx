              ...
              <CardContent className="p-6">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                  ...
                  <Select
                    ...
                    onValueChange={(value) => handleFilterChange({ hasProject: value === 'all' ? undefined : value })}
                  >
                    <SelectTrigger>
                    ...
                    <CardContent className="p-6">
                      ...
                      <div className="space-y-2 mb-4">
                        ...
                        <div className="flex justify-between text-sm">
                         ...
                         <div className="flex justify-between text-sm">
                          <span className="text-gray-600 dark:text-gray-400">Matric No:</span>
                          <span className="text-gray-900 dark:text-white truncate ml-2">
                            {student.matric_no}
                          </span>
                        </div>
                      ...
                      <div className="mt-4 flex gap-2">
                        ...
                        {student.project_count > 0 && (
                          <Link to={`/supervisor/students/${student.id}/projects`}>
